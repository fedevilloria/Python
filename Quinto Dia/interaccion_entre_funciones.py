...
#Practica Interaccion con Funciones 1:
...
#Practica Interaccion con Funciones 2:
...
def reducir_lista(lista):
    lista = list(set(lista_numeros)) #Lo transformo a set para eliminar los repetidos
    lista.sort() #Ordeno la lista
    lista.pop(-1) #Saco el ultimo numero el cual es el mayor
    return lista

def promedio(lista):
    suma = 0
    for n in reducir_lista(lista):
        suma = suma + n #Acumulador de los numeros sumados
    promedio_numeros = suma / len(lista) #Utilizo el acumulador dividido la longitud de la lista para obtener el promedio
    return promedio_numeros

#Practica Interaccion con Funciones 3:
